...
<html lang="en">
  <head>
    ...
    <title>Client Request Plan </title>
  </head>
  <style>
body {
...
background-size: 1350px 900px;
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:300px'>CLIENT REQUEST PLAN </h4></center>
     <center><h4><a  href="CV_homepg.html"> <button type="button" class="btn btn-outline-warning">HOME</button></a></h4></center>
        ...
        <table class="table table-striped custom-table">
          ...
          <%
					    ResultSet rs1=null;
						  try{
							  String qry2 = "Select * from cl_chooseplan"; 
                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						   ...
						   <td>
						      <form action="CV_updateplan"  method="post">  
						      <input type="hidden" name="name" value="<%=rs1.getString(1)%>"> 
						      <input type="hidden" name="fkey" value="<%=rs1.getString(2)%>"> 
						      <input type="hidden" name="service" value="<%=rs1.getString(3)%>"> 
						      <input type="hidden" name="plan" value="<%=rs1.getString(4)%>"> 
						      <input type="hidden" name="validity" value="<%=rs1.getString(5)%>"> 
						      <input type="hidden" name="storage" value="<%=rs1.getString(6)%>"> 
						       <button class="button1" value="approved" name="name" style='background-color:green;color:white;'>UPDATE</button> 
