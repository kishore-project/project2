...
<html lang="en">
  <head>
    ...
    <title>Cloud Vendor View Payment Status </title>
  </head>
  <style>
body {
...
background-size: 1350px 900px;
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:300px'> PAYMENT STATUS </h4></center>
     <center><h4><a  href="CV_homepg.html"><button type="button" class="btn btn-outline-warning">HOME</button></a></h4></center>
        ...
        <table class="table table-striped custom-table">
          ...
          <%
					    ResultSet rs1=null;
						  try{
							  String qry2 = "Select * from cl_payment"; 
