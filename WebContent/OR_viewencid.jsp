...
background-size: 1350px 900px;
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:300px'>VIEW ENCRYPT DATA </h4></center>
     <center><h4><a  href="OR_homepg.html"><button type="button" class="btn btn-outline-warning">HOME</button></a></h4></center>
          ...
          <%
                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						      ...
						      <td> 
						       <a href="OR_viewencdata.jsp" ><button class="button" style='background-color:green;color:white;border:2px solid black; font-size: 15px; padding:10px 18px;'>VIEW</button></a>
						       </td>  
                       </tr>
