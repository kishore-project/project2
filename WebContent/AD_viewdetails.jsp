...
<html lang="en">
  <head>
    ...
    <title>Admin See Client Details </title>
  </head>
  <style>
body {
...
background-size: 1350px 900px;
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:300px'>DOWNLOAD AND UPLOAD</h4></center>
                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						      ...
						      <td><%=rs1.getString(4) %></td> 
						       ...
						       <td>
						      <form action="AD_downloaddata" method="get">
						       <button class="button" style='background-color:green;font-size:15px;padding: 7px 10px;'>DOWNLOAD</button>
						       </form>
						       </td>
						      <td>
						      <form action="AD_upload.jsp" method="post">
						       <input type="hidden" name="name" value="<%=rs1.getString(4)%>"> 
						       <button class="button" style='background-color:green;font-size:15px;padding: 7px 10px;'>UPLOAD</button>
						       </form>
						       </td>
                     </tr>
