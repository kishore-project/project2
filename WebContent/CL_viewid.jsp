     ...
     <center><h4><a  href="CL_homepg.html"><button type="button" class="btn btn-outline-warning">HOME</button></a></h4></center>
        ...
        <table class="table table-striped custom-table">
          ...
          <%
					    ResultSet rs1=null;
						  try{
							  String qry2 = "Select * from ad_keys"; 
                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						      ...
						      <td><%=rs1.getString(3) %></td>
						       ...
						       <form action="CL_downloaddata" method="get">
						        <button class="button" style='background-color:green;color:white;border:2px solid black; font-size: 15px; padding:10px 18px;'>DOWNLOAD</button>
						      </form>
						       </td>  
                       </tr>
