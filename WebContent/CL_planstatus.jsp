  ...
  <div class="content">
    ...
    <div class="container">
     <!--  <h2 class="mb-5">Table #7</h2> -->
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:250px'> PLAN STATUS </h4></center>
     <center><h4><a  href="CL_homepg.html"><button type="button" class="btn btn-outline-warning">HOME</button></a></h4></center>
          ...
          <%
                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						      ...
						      <td>
						     <form action="CL_payment.jsp"  method="post">
						     <input type="hidden" name="name" value="<%=rs1.getString(1)%>"> 
						     <input type="hidden" name="plan" value="<%=rs1.getString(1)%>">  
						      <button  style='background-color:green;font-size: 20px;'>PAYMENT</button>
