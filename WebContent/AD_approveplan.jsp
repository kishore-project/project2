...
<html lang="en">
  <head>
    ...
    <title>Admin Approve Plan </title>
  </head>
  <style>
body {
...
background-size: 1350px 900px;
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <center><h4 class="text-center mb-4" style='background-color:lightskyblue;width:350px'>CLIENT REQUEST PLAN </h4></center>
                     ...
                     <tbody style='background-color:white;'>
                         <tr>
						      ...
						      <td><%=rs1.getString(6) %></td>
						       ...
						       <td>
						     <form action="AD_acceptplan"  method="post">
						     <input type="hidden" name="name" value="<%=rs1.getString(1)%>">  
						     <button value="approved" name="status" style='background-color:green'>ACCEPT</button><br>
						     <br> <button value="rejected" name="status" style='background-color:red'>REJECT</button>  
						      </form>
						      </td>                                                   
                       </tr>
