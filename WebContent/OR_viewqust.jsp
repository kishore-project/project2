                     ...
                     <tbody style='background-color:white;color:black;'>
                         <tr>
						      ...
						      <td><%=rs1.getString(6) %></td>
						       ...
						       <td>
						       <form action="OR_query" method="post">
						       <input type="hidden" name="name" value="<%=rs1.getString(1)%>">
						       <button value="approved" name="status" style='background-color:green;font-size: 15px;'>ACCEPT</button>
						       <button value="rejected" name="status" style='background-color:red;font-size: 15px;'>REJECT</button>
						      </form>
						       </td> 
                       </tr>
